    ...
    <div className="relative flex justify-center items-center h-[100vh] b bg-[url('/images/undraw_login_re_4vu2.svg')] bg-[length:700px_400px] bg-no-repeat bg-center">
      <div className="shadow-lg flex items-center justify-center rounded flex-col w-[500px] h-[500px] py-8 bg-[#ffffffe0] backdrop-filter backdrop-blur-md backdrop-saturate-50">
        ...
        <div className="w-3/4 mt-4">
            ...
            <input className="rounded w-full px-2 py-3 bg-transparent border-2 border-black-800" type="text" name="username" placeholder="Username" />
           </div>
            <div className="mb-4">
            ...
            <button className="rounded w-full bg-[var(--pr-col)] hover:bg-black py-3 text-white font-bold">Sign up</button>
            
          </form>
          <div className="mt-4">
            <span>Already have an account? </span> <Link href={"/auth/login"}>
            <button className="text-[#43007E]">Login</button></Link>
          </div>
        </div>
      </div>
    </div>
